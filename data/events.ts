...
export const allVenues: Venue[] = [
    ...
    },
    {
      "id": "venue-35",
      "name": "VEC Pier 80",
      "address": "Jan Kobellstraat 51, Rotterdam",
      "city": "Rotterdam",
      "lat": 51.91353,
      "lng": 4.43981,
      "category": "COMMUNITY",
      "about": "Locatie voor aanschuifmaaltijden in Delfshaven.",
      "logoUrl": "https://raw.githubusercontent.com/rsx247/DAK/main/assets/logos/thumbs/huisvdwijk.webp",
      "verificationStatus": "VERIFIED"
    },
    {
      "id": "venue-36",
      "name": "Huis vd Wijk Pier 80",
      "address": "Rösener Manzstraat 80, 3026 TV Rotterdam",
      "city": "Rotterdam",
      "lat": 51.912525,
      "lng": 4.44148,
...
export const allEvents: EventData[] = [
    ...
    {
      "id": "event-10",
      "title": "Aanschuifmaaltijd De Inloop (afhalen)",
      "description": "Elke vrijdag een maaltijd om af te halen. Let op: niet Halal. Bestellen kan tot 1 dag van tevoren.",
      ...
      "registrationInfo": {
        "type": "PHONE",
        "value": "0102457447",
        "notes": "Bestellen kan tot 1 dag van tevoren voor 15:00 uur. Alleen afhalen."
      }
    },
    {
      "id": "event-11",
    ...
    {
      "id": "event-13",
      "title": "Aanschuifmaaltijd",
      "description": "Elke woensdag een gezellige aanschuifmaaltijd. Alle gerechten zijn Halal. Bestellen kan tot 2 dagen van tevoren.",
      ...
      "registrationInfo": {
        "type": "PHONE",
        "value": "0102680308",
        "notes": "Bestellen kan tot 2 dagen van tevoren voor 15:00 uur."
      }
    },
    {
      "id": "event-14",
      "title": "Aanschuifmaaltijd Schiemond",
      "description": "Elke donderdag een heerlijke maaltijd bereid door koks uit de wijk. Halal. Bestellen kan tot 1 dag tevoren tot 15.00 uur.",
      "startTime": new Date("2025-11-03T18:00:00.000Z"),
      "endTime": new Date("2025-11-03T19:30:00.000Z"),
      "venueId": "venue-9",
      "foodType": "MEALS",
      "dietaryTags": [
        "halal"
      ...
      "registrationInfo": {
        "type": "PHONE",
        "value": "0102680310",
        "notes": "Bestellen kan tot 1 dag van tevoren voor 15:00 uur."
      }
    },
    {
      "id": "event-15",
    ...
    },
    {
      "id": "event-16",
      "title": "Aanschuifmaaltijd",
      "description": "Elke maandag een gezellige aanschuifmaaltijd. Halal. Bestellen kan tot 1 dag van tevoren.",
    ...
    },
    {
      "id": "event-17",
      "title": "Aanschuifmaaltijd",
      "description": "Elke dinsdag een gezellige buurtmaaltijd. Let op: niet Halal. Bestellen kan tot 1 dag van tevoren.",
      "startTime": new Date("2025-11-10T17:00:00.000Z"),
    ...
    {
      "id": "event-45",
      "title": "Aanschuifmaaltijd Pier 80",
      "description": "Elke dinsdag een gezellige aanschuifmaaltijd in Pier 80. Halal. Bestellen kan tot 1 dag van tevoren.",
      "startTime": new Date("2025-01-01T17:00:00.000Z"),
      "endTime": new Date("2025-01-01T19:00:00.000Z"),
      "venueId": "venue-36",
      "foodType": "MEALS",
      "dietaryTags": [
        "halal"
    ...
    {
      "id": "event-46",
      "title": "Aanschuifmaaltijd VEC Pier 80",
      "description": "Elke donderdag een gezellige aanschuifmaaltijd. Halal. Bestellen kan tot 1 dag van tevoren.",
      "startTime": new Date("2025-01-01T17:00:00.000Z"),
      "endTime": new Date("2025-01-01T19:00:00.000Z"),
      "venueId": "venue-35",
      "foodType": "MEALS",
