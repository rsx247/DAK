        ...
        >
            <div className="flex flex-col sm:flex-row justify-between">
                <div className="flex-grow">
                    ...
                    <p className="text-sm text-text-secondary mt-1 max-w-prose">{event.description}</p>
                </div>
                <div className="flex-shrink-0 mt-3 sm:mt-0 sm:ml-6 text-sm text-text-secondary text-left sm:text-right">
