...
import type { Venue, FoodEvent } from '../../types';
...
export const AdminVenueList: React.FC<AdminVenueListProps> = ({ venues, onEdit, onDelete, events, onEditEvent, onDeleteEvent }) => {
  if (venues.length === 0) {
