...
import { ChevronLeftIcon, BreakPatternIcon } from '../Layout/Icons';
...
const CollapsedHeaderSegment: React.FC<{ segment: TimelineSegment }> = ({ segment }) => (
    ...
    >
        <BreakPatternIcon className="w-4 h-4 text-gray-300" />
    </div>
);
...
export const TimelineHeader: React.FC<TimelineHeaderProps> = ({
    ...
    return (
        <div className="sticky top-0 z-30 flex bg-surface shadow-[0_1px_0_0_#EBEBEB] dark:shadow-[0_1px_0_0_#374151]">
