...
export const allVenues: Venue[] = [
    ...
    },
    {
      ...
      "category": "COMMUNITY",
      "about": "Informatie onbekend",
      "logoUrl": "https://raw.githubusercontent.com/rsx247/DAK/main/assets/logos/thumbs/logo-wmoradar.webp",
      "verificationStatus": "NEEDS_VERIFICATION"
    },
    {
      "id": "venue-7",
...
export const allEvents: EventData[] = [
    ...
    },
    {
      ...
      "registrationDeadline": new Date("2025-11-02T14:00:00.000Z"),
      "registrationInfo": {
        "type": "URL",
    ...
    },
    {
      ...
      "dietaryTags": [],
      "accessLevel": "REGISTRATION",
      "registrationDeadline": new Date("2025-11-05T10:00:00.000Z"),
      "cost": "€4,00",
      "verificationStatus": "VERIFIED",
