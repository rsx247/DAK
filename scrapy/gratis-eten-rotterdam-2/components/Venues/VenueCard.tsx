...
export const VenueCard: React.FC<VenueCardProps> = ({ venue, isCollapsed, zoomLevel }) => {
  ...
  if (zoomLevel === 0) {
    if (isCollapsed) {
      ...
      return (
        <div className="w-6 h-6 transition-all duration-300 ease-in-out" title={venue.name}>
          <VenueLogo
            venue={venue}
    ...
    return (
      <div className="bg-white p-2 rounded-lg w-full h-full flex items-center" title={venue.name}>
  ...
  if (isCollapsed) {
    ...
    return (
      <div className={`${size} transition-all duration-300 ease-in-out`} title={venue.name}>
        <VenueLogo 
            venue={venue} 
  ...
  return (
    <div className="bg-white p-2 rounded-lg w-full h-full transition-all duration-300 ease-in-out flex items-center gap-3">
      <div className={`flex-shrink-0 ${logoSize}`}>
        <VenueLogo 
            venue={venue} 
            className="w-full h-full object-cover rounded-lg shadow-sm"
